...
from SStV2Ref.vocoder.distribution import sample_from_discretized_mix_logistic
from SStV2Ref.vocoder.display import *
from SStV2Ref.vocoder.audio import *
...
class WaveRNN(nn.Module):
    ...
    def forward(self, x, mels):
        self.step += 1
        bsize = x.size(0)
        if torch.cuda.is_available() and 1==5:
